    ...
    <main className="px-6 md:px-10 lg:px-20 py-16">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link
            href="/news"
            className="self-start inline-flex items-center gap-2 text-white bg-[#1E4080] font-light rounded-full py-2.5 px-5 pr-6 hover:bg-[#0B1C3C] transition-colors duration-300 text-sm shrink-0"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col gap-4">
          <span className={`inline-flex w-fit rounded-full px-4 py-2 text-sm font-medium ${categoryStyle[item.category] ?? "bg-gray-100 text-gray-600"}`}>
            {item.category}
          </span>
