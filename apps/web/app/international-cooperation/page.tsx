...
const partners = [
  ...
  },
  {
    ...
    flag: "🇺🇸",
    desc: "Оценка применимости малых модульных реакторов (SMR) для площадки Майнкум. Консультации по ядерному нераспространению и безопасности.",
    tags: ["SMR / Малые реакторы", "Нераспространение", "Майнкум"],
  },
  {
...
const timeline = [
  ...
  },
  {
    ...
    desc: "Переговоры с потенциальными поставщиками технологий. Оценка технологических предложений для площадок Балхаш и Майнкум.",
  },
  {
    year: "2025–н.в.",
