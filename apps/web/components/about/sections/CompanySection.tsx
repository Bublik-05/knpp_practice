...
export default function CompanySection() {
  return (
    <section id="section-about" className="flex flex-col gap-4 scroll-mt-24">
      <h2 className="text-3xl font-medium text-gray-900">О ТОО «КАЭС»</h2>
      ...
      <div className="flex gap-10 items-start">
        ...
        <div className="shrink-0 w-55 h-55 relative self-start">
          <Image src="/images/activities/atomic_energy.svg" alt="КАЭС" fill className="object-contain" />
        </div>
      </div>
    </section>
  );
