...
const items = [
  {
    ...
    a: "Актуальные вакансии размещены в разделе «Вакансии» на нашем сайте. Вы можете откликнуться через форму на странице конкретной вакансии или направить резюме на электронную почту kense@knpp.kz с указанием желаемой должности в теме письма.",
  },
  {
    q: "Как стать поставщиком товаров или услуг для КАЭС?",
    a: "Информация о закупках и тендерах публикуется в разделе «Закупки». Для участия необходимо пройти квалификацию поставщика. Подробности и требования можно уточнить по электронной почте kense@knpp.kz или по телефону +7 (7172) 24 84 50.",
  },
  {
    q: "Как связаться с пресс-службой КАЭС?",
    a: "Представители СМИ и партнёры могут направлять запросы на адрес kense@knpp.kz или звонить по телефону +7 (7172) 24 84 50. Мы стараемся отвечать на все обращения в течение двух рабочих дней.",
  },
];
