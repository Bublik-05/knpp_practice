...
const values = [
  {
    ...
    desc: "Обеспечение Казахстана надёжной, безопасной и современной атомной энергетикой, способствующей устойчивому развитию экономики и укреплению энергетической независимости страны.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
    ...
    desc: "Проектирование и сопровождение объектов атомной энергетики, научно-исследовательские работы, инженерные изыскания, техническое консультирование и участие в развитии энергетической инфраструктуры.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
    ...
    desc: "Внедрение передовых решений в атомной отрасли, развитие национальных компетенций и формирование современной технологической базы для будущих энергетических проектов.",
  },
];
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-start">
          <div className="lg:w-1/3 shrink-0">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
              О компании <br className="hidden lg:block" />
              ТОО «КАЭС»
            </h2>
          </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-white/85 text-xl lg:text-2xl font-light leading-relaxed">
              ТОО «Казахстанские атомные электрические станции» — компания, ориентированная на развитие атомной энергетики в Казахстане, подготовку инфраструктуры будущих проектов и внедрение современных технологических решений в отрасли.
            </p>
          </div>
        </div>
