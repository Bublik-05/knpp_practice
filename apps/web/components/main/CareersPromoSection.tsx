    ...
    return (
        <section className="px-30 pb-24">
            <div className="mx-auto w-full max-w-8xl">
                <Link
                    href="/vacancies"
                    className="group block overflow-hidden rounded-[32px] border border-[#d9e2f2] bg-gradient-to-br from-[#f8fbff] via-white to-[#eef4ff] shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(30,64,128,0.14)]"
                >
                    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
                        <div className="relative p-8 md:p-10 lg:p-12">
                            <div className="absolute right-0 top-0 h-40 w-40 rounded-full bg-[#1E4080]/6 blur-3xl" />
                            <div className="relative z-10 flex h-full flex-col">
                                <span className="inline-flex w-fit rounded-full border border-[#dbe5f4] bg-white px-4 py-2 text-sm font-medium text-[#1E4080]">
                                    Карьера в компании
                                </span>
                                ...
                                <div className="mt-8 flex flex-wrap gap-4">
                                    <div className="min-w-[180px] rounded-2xl border border-[#dbe5f4] bg-white px-5 py-4 shadow-sm">
                        ...
                        <div className="relative min-h-[320px] border-t border-[#dbe5f4] bg-[#eef4ff] lg:min-h-[620px] lg:border-l lg:border-t-0">
                            ...
                            <div className="absolute left-5 top-5 rounded-2xl border border-white/60 bg-white/80 px-4 py-3 backdrop-blur-sm">
                            ...
                            <div className="absolute bottom-5 right-5 rounded-2xl border border-white/60 bg-white/85 px-4 py-3 backdrop-blur-sm shadow-sm">
