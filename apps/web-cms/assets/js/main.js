...
function initNewsDetail() {
  if (!document.getElementById('nd-title')) return; // only on news-detail.html
  ...
  var NEWS_DATA = [
    {
      ...
      summary: 'В феврале 2026 года представители ТОО «КАЭС» провели серию координационных встреч с экспертами Международного агентства по атомной энергии (МАГАТЭ) в рамках подготовки к миссии интегрированной проверки инфраструктуры ядерной энергетики (INIR).',
      body: 'Миссия INIR является ключевым инструментом МАГАТЭ для оценки готовности страны к развитию ядерной энергетики. В ходе встреч обсуждались вопросы безопасности, регуляторной базы, подготовки кадров и технической готовности площадки.\n\nПо итогам встреч стороны определили перечень документов и мероприятий, необходимых для успешного прохождения миссии, намеченной на вторую половину 2026 года. Эксперты МАГАТЭ высоко оценили уровень подготовки казахстанской стороны и выразили готовность продолжить техническое содействие.'
    },
    {
      ...
      summary: '2025 год стал важным этапом в развитии атомной энергетики Казахстана. ТОО «КАЭС» подвело итоги проделанной работы и обозначило приоритеты на 2026 год.',
      body: 'В течение года были достигнуты значительные результаты в области подготовки к строительству АЭС: завершена первая фаза технико-экономического обоснования, подписаны меморандумы о сотрудничестве с ведущими ядерными организациями мира, проведены общественные слушания в регионах расположения площадок.\n\nТОО «КАЭС» планирует в 2026 году завершить разработку предварительного отчёта по обоснованию безопасности и приступить к следующему этапу предпроектных работ.'
    },
    {
      ...
      summary: 'ТОО «КАЭС» подписало ряд меморандумов о взаимопонимании с ведущими организациями атомной отрасли, расширив круг международного сотрудничества.',
      body: 'Подписанные документы охватывают направления технического содействия, обмена опытом, подготовки кадров и совместных научных исследований. Партнёрство позволит казахстанским специалистам получить доступ к передовым технологиям и лучшим мировым практикам в области ядерной энергетики.\n\nСотрудничество с международными партнёрами является неотъемлемой частью стратегии ТОО «КАЭС» по обеспечению высочайшего уровня безопасности и эффективности будущей атомной электростанции.'
    },
    {
      ...
      summary: 'В Алматы состоялась международная конференция по вопросам ядерной безопасности и развития атомной энергетики в Центральной Азии, в которой приняли участие эксперты более чем из 20 стран.',
      body: 'На конференции были рассмотрены актуальные вопросы ядерной безопасности, опыт эксплуатации действующих АЭС, перспективы малых модульных реакторов и роль атомной энергии в достижении углеродной нейтральности. Представители ТОО «КАЭС» выступили с докладами о ходе предпроектных работ в Казахстане.\n\nКонференция стала важной площадкой для обмена опытом и укрепления международного сотрудничества в сфере мирного использования атомной энергии.'
    },
    {
      ...
      summary: 'Делегация экспертов МАГАТЭ посетила офис ТОО «КАЭС» и ознакомилась с ходом предпроектных работ по строительству атомной электростанции в Казахстане.',
      body: 'В рамках визита эксперты МАГАТЭ провели рабочие встречи с руководством и специалистами ТОО «КАЭС», обсудили вопросы ядерной безопасности, регуляторного надзора и подготовки персонала. Особое внимание было уделено соответствию проводимых работ международным стандартам и рекомендациям агентства.\n\nПо итогам визита делегация подтвердила готовность МАГАТЭ оказывать всестороннее техническое содействие Казахстану в развитии ядерной инфраструктуры.'
    },
    {
      ...
      summary: 'На ежегодном Форуме энергетиков Центральной Азии ТОО «КАЭС» представило обновлённую концепцию развития атомной генерации как ключевого элемента энергобаланса региона.',
      body: 'Форум собрал руководителей энергетических компаний, регуляторов и экспертов из Казахстана, Кыргызстана, Таджикистана, Туркменистана и Узбекистана. В фокусе дискуссий — переход к низкоуглеродной энергетике и обеспечение энергетической безопасности региона.\n\nПредставители ТОО «КАЭС» подробно рассказали о двух проектах АЭС — «Балхаш» и «Мойынкум» — и ответили на вопросы участников форума об экологических стандартах, технологиях и сроках реализации проектов.'
    },
    {
      ...
      summary: 'ТОО «КАЭС» объявляет о завершении первого этапа предпроектных работ и начале второго этапа проектирования атомной электростанции в Казахстане.',
      body: 'Первый этап включал оценку площадок, предварительный анализ безопасности, технико-экономическое обоснование и взаимодействие с регулятором. По результатам проведённых работ подтверждена техническая обоснованность проектов и их соответствие международным стандартам безопасности.\n\nВторой этап предусматривает разработку детального технического задания, углублённый анализ безопасности площадок и подготовку материалов для лицензирования. ТОО «КАЭС» продолжает работу в тесном взаимодействии с уполномоченными государственными органами и международными партнёрами.'
    },
    {
      ...
      summary: 'В соответствии с принципами прозрачности и открытости ТОО «КАЭС» публикует отчёт о мониторинге экологической ситуации в районах предполагаемого строительства за первое полугодие 2025 года.',
      body: 'Отчёт охватывает результаты мониторинга атмосферного воздуха, поверхностных и подземных вод, почвенного покрова, а также данные радиационного фонового мониторинга. Все показатели находятся в пределах установленных нормативов и соответствуют требованиям казахстанского законодательства и международных стандартов.\n\nТОО «КАЭС» придерживается принципа открытости в вопросах экологического мониторинга. Полный текст отчёта доступен на официальном сайте компании.'
    },
    {
      ...
      summary: 'Пресс-служба ТОО «КАЭС» комментирует итоги переговоров с французской компанией EDF по вопросам технического сотрудничества в рамках проектирования АЭС.',
      body: 'Переговоры прошли в конструктивной атмосфере. Стороны обсудили возможные форматы технического взаимодействия, включая передачу опыта, подготовку специалистов и участие в отдельных этапах проектирования. Окончательное решение о технологическом партнёре будет принято по итогам всестороннего тендерного процесса с учётом технических, экономических и иных критериев.\n\nТОО «КАЭС» поддерживает диалог со всеми ведущими поставщиками ядерных технологий и намерено выбрать наилучшее решение для Казахстана.'
    }
  ];

  var params   = new URLSearchParams(window.location.search);
  var slug     = params.get('slug') || '';
  var item     = NEWS_DATA.find(function (n) { return n.slug === slug; });

  var titleEl  = document.getElementById('nd-title');
  var dateEl   = document.getElementById('nd-date');
  var badgeEl  = document.getElementById('nd-badge');
  var imageEl  = document.getElementById('nd-image');
  var bodyEl   = document.getElementById('nd-body');
  var bcCurEl  = document.getElementById('nd-bc-cur');
  var mainEl   = document.getElementById('news-detail-main');
  var notFound = document.getElementById('nd-404');
  ...
  if (!item) {
    ...
    if (imageEl)  imageEl.closest('.news-detail-hero').style.display = 'none';
    if (bodyEl)   bodyEl.style.display   = 'none';
    if (notFound) notFound.style.display = 'block';
    document.title = 'Страница не найдена — ТОО «КАЭС»';
    return;
  }
  ...
  var shortTitle = item.title.length > 50 ? item.title.slice(0, 50) + '…' : item.title;
  if (bcCurEl)  bcCurEl.textContent  = shortTitle;
  if (titleEl)  titleEl.textContent  = item.title;
  if (dateEl)   dateEl.textContent   = item.date;

  if (badgeEl) {
    badgeEl.textContent = item.category;
    badgeEl.className   = 'news-detail-badge ' + (
      item.category === 'Новости'      ? 'news-cat--news'   :
      item.category === 'События'      ? 'news-cat--events' :
                                         'news-cat--press'
    );
  }
